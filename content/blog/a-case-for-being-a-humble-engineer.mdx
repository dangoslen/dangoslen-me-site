...
The myth has become somewhat of [a joke these days](https://i.kym-cdn.com/entries/icons/original/000/030/429/10x-Engineer-784x441.jpg), but there remains some residue about this idea that to get ahead, you have to put yourself first. You are suppossed to [avoid humility](https://medium.com/javascript-in-plain-english/a-20-year-experienced-ctos-advice-don-t-be-a-humble-developer-919973e8ca5) and opt for a winner takes all approach.
...
<InfoCard>
  ...
  <i>Talking about humility on a post is always a bit awkward. I'll be upfront that while I aim to be like the engineer described below, in many ways, I'm still learning to adopt these behaviors, meaning I have regular mistteps. There is grace in a data point as long as the trend is the right direction.</i>
