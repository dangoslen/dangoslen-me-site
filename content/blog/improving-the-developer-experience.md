...
When I first read [The Phoenix Project](https://www.goodreads.com/en/book/show/17255186) I couldn't put it down. I might have read the whole book in less than a week (which is fast for a slow reader like myself). There was something so relatable about the characters and the setting. So relatable, in fact, that some parts were painful to read.

When I picked up [The Unicorn Project](https://www.goodreads.com/book/show/44333183-the-unicorn-project) a few years later, I had a similar but even more visceral reaction. The author, [Gene Kim](https://itrevolution.com/author/gene-kim/), had somehow found a way to describe every pain point I had experienced in my development career! I read along and cheered (I think out loud) as Maxine navigated the complexities of code and political land mines with persistence and skill.
